...
init_vals <- function() {
  list(phi_raw=c(.001,.0001),
       ...
       mu_test_raw=rep(0,real_data$num_country),
       mu_test_raw2=rep(0,real_data$num_country),
       ...
       pcr_spec=-6,
       sigma_test_raw=0.01,
       sigma_test_raw2=0.01,
       sigma_test_raw3=0.01,
...
if(run_model) {
  pan_model_scale <- cmdstan_model("corona_tscs_betab_mix_prior.stan",
   ...
   us_fit_scale_mod <- pan_model_scale$sample(data=real_data,
                           threads_per_chain = 10,init=init_vals,
                           iter_warmup = 250,
                           iter_sampling = 250,
                           max_treedepth = 16,
                           chains=1)
...
```{r priors, fig.cap="Comparison of Predicted Infections Versus Prior Information for States"}
